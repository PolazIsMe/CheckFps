-- Polaz FPS | CheckFps (FINAL FIXED)
...
frame.Position = UDim2.new(1, -260, 0, 25)
...
darkBtn.MouseButton1Click:Connect(function()
	...
	title.TextColor3 = dark and Color3.fromRGB(160,160,160) or Color3.fromRGB(120,120,120)
end)
...
minBtn.MouseButton1Click:Connect(function()
	...
	TweenService:Create(
		...
		{Size = minimized and UDim2.new(0, 55, 0, 45) or UDim2.new(0, 240, 0, 170)}
	):Play()
end)
